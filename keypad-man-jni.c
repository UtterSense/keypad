...
Java_net_uttersense_libkeypad_KeypadManager_stringFromJNI(JNIEnv *env, jobject thiz) {
...
Java_net_uttersense_libkeypad_KeypadManager_initialise(JNIEnv *env, jobject thiz) {
...
Java_net_uttersense_libkeypad_KeypadManager_close(JNIEnv *env, jobject thiz) {
...
JNIEXPORT void JNICALL
Java_net_uttersense_libkeypad_KeypadManager_toggle(JNIEnv *env, jobject thiz) {
...
JNIEXPORT void JNICALL
Java_net_uttersense_libkeypad_KeypadManager_switchLED(JNIEnv *env, jobject thiz, jint mode) {
